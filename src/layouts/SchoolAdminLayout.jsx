...
const items=[
 ...
 ["/school/admin/security",FaShieldAlt,"أمن وصحة النظام"],
 ["/school/admin/operations-setup",FaCogs,"التشغيل الأكاديمي"],
 ["/school/admin/smart-timetable",FaClock,"الجدول الذكي"],
 ["/school/admin/student-affairs",FaClipboardCheck,"شؤون الطلاب"],
 ["/school/admin/gradebook",FaChartBar,"دفتر الدرجات الموحد"],
 ["/school/admin/hr-center",FaUsers,"مركز الموارد البشرية"],
 ["/school/admin/control-center",FaShieldAlt,"مركز التحكم النهائي"],
 ["/school/admin/access-management",FaUserShield,"المستخدمون والصلاحيات"],
 ["/school/admin/portals",FaShieldAlt,"بوابات النظام"]
];
 ...
 return <div dir="rtl" className="min-h-screen bg-[#f6f8fb] lg:flex">
  <aside className="bg-[#12345b] text-white lg:min-h-screen lg:w-[280px] lg:shrink-0">
   <div className="border-b border-white/10 p-5">
    ...
    <button onClick={logout} className="mt-4 flex w-full items-center justify-center gap-2 rounded-xl bg-red-500/15 px-4 py-3 text-sm font-bold text-red-100 hover:bg-red-500/25"><FaSignOutAlt/>تسجيل الخروج</button>
   </div>
