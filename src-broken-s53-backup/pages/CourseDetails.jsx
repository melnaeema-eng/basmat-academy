...
export default function CourseDetails() {
      ...
      <MainLayout>
        <div className="flex min-h-[60vh] items-center justify-center px-6">
          <div className="max-w-lg rounded-2xl bg-white p-8 text-center shadow-lg">
            ...
            <Link
              to="/courses"
              className="mt-6 inline-block rounded-lg bg-[#08284d] px-6 py-3 font-semibold text-white hover:bg-blue-800"
            >
  ...
  return (
    <MainLayout>
      <main dir={i18n.dir()} className="min-h-screen bg-[#f7f9fc]">
        ...
        <section className="mx-auto grid max-w-7xl gap-8 px-6 py-12 lg:grid-cols-[2fr_1fr]">
          ...
          <aside>
            <div className="sticky top-6 overflow-hidden academy-card-lg">
              <img
                src={
                  course.image ||
