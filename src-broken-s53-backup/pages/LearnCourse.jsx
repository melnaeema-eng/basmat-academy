              ...
              {!selectedLesson ? (
                ...
                <>
                  ...
                  {selectedLesson.lesson_type === 'text' && (
                    <div className="mt-6 whitespace-pre-wrap rounded-xl bg-[#f7f9fc] p-5 leading-8">{selectedLesson.content || 'لا يوجد محتوى نصي.'}</div>
                  )}

                  {selectedLesson.lesson_type === 'file' && selectedLesson.file_url && (
                    <a className="mt-6 inline-block rounded-lg bg-[#08284d] px-5 py-3 font-semibold text-white" href={selectedLesson.file_url} target="_blank" rel="noreferrer">فتح ملف الدرس</a>
                  )}
