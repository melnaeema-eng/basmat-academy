...
export default function Lessons() {
  ...
  return (
    <div dir={i18n.language?.startsWith("ar") ? "rtl" : "ltr"} className="space-y-7">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <h1 className="academy-title text-3xl">إدارة دروس الدورة</h1>
      ...
      <form onSubmit={submit} className="academy-card p-5 md:p-6 space-y-4">
