...
export async function saveSchoolExamPeriod(x){
 const row={academic_year_id:x.academic_year_id,name_ar:x.name_ar.trim(),name_en:x.name_en?.trim()||null,exam_type:x.exam_type,term_no:Number(x.term_no),starts_on:x.starts_on,ends_on:x.ends_on,is_published:!!x.is_published};
