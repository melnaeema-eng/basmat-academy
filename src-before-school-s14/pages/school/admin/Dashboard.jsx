...
import {getSchoolCore,getSchoolS2Health,getSchoolS3Health,getSchoolS4Health,getSchoolS5Health,getSchoolS6Health,getSchoolS7Health,getSchoolS8Health,getSchoolS9Health,getSchoolS10Health,getSchoolS11Health,getSchoolS12Health,getSchoolS13Health} from "../../../services/schoolService";
...
export default function SchoolDashboard(){
 ...
 useEffect(()=>{Promise.all([getSchoolCore(),getSchoolS2Health(),getSchoolS3Health(),getSchoolS4Health(),getSchoolS5Health(),getSchoolS6Health(),getSchoolS7Health(),getSchoolS8Health(),getSchoolS9Health(),getSchoolS10Health(),getSchoolS11Health(),getSchoolS12Health(),getSchoolS13Health()]).then(([a,b,c,d,e,f,g,h,i,j,k,l,m])=>{setData(a);setS2(b);setS3(c);setS4(d);setS5(e);setS6(f);setS7(g);setS8(h);setS9(i);setS10(j);setS11(k);setS12(l);setS13(m)}).catch(e=>setError(e.message))},[]);
 const h=data?.health||{};
 const cards=[
