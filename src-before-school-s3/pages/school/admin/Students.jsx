...
const emptyStudent={full_name_ar:"",full_name_en:"",gender:"",date_of_birth:"",nationality:"Sudanese",phone:"",email:"",status:"active",admission_date:new Date().toISOString().slice(0,10),notes:""};
